      ...
      <div className="w-full max-w-md mt-10 px-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 w-full">
          ...
          <form className="space-y-5" onSubmit={submithandler}>
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl font-semibold text-lg text-white bg-linear-to-r from-indigo-500 to-blue-500 hover:from-blue-600 hover:to-indigo-500 transition-all duration-500 shadow-md hover:shadow-lg"
            >
              Sign In
            </button>
          </form>
